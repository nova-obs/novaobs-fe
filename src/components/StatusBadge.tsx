const statusClass: Record<string, string> = {
  ...
  converged: 'border-emerald-600/20 bg-emerald-50 text-emerald-700',
  ...
  pending_observation: 'border-primary/25 bg-primary-soft text-primary',
  ...
  not_started: 'border-outline bg-surface-low text-muted',
  ...
  not_deployed: 'border-outline bg-surface-low text-muted',
